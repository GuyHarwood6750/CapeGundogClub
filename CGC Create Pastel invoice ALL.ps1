...
#>
$inspreadsheet = 'C:\Users\Guy\Dropbox\CGC\2024\Financials\Invoicing Income and Expenses\Income.xlsx'     #Spreadsheet from Booking System
$startR = 1                                     #Start row
$endR =  18                                   #End Row
...
$custsheet = 'Invoice_2024'                           #Customer worksheet IN $inspreadsheet (do not change)
#
$Outfile = $pathout + $csvfile
$Outfile2 = $pathout + $csvfile2
$Outfile4 = $pathout + $pastelfile
#
Import-Excel -Path $inspreadsheet -WorksheetName $custsheet -StartRow $startR -StartColumn $startCol -EndRow $endR -EndColumn $endCol | Where-Object -FilterScript {$_.AccCode -like "*" -and $_.Event -like "*" -and $_.Generate -eq "Yes"} | Export-CSV -Path $Outfile -NoTypeInformation
#
...
$data = Import-Csv -path $Outfile2 -header accnum, name, date, dog, amt, event, type, comment, eventdate
...
foreach ($aObj in $data) {
    ...
    Switch ($aObj.type) {
        ...
        AMMO {$incomeAcc = '2000004'}
        DONATION {$incomeAcc = '1500000'}
    ...
    $detailProperties = [ordered] @{
        ...
        #Col11 = $aobj.dog + " : " + $aObj.Event
        Col11 = $aObj.Event + " : " + $aObj.dog
        Col12 = '6'
        Col13 = ''
        Col14 = ''
        Col15 = ''
