...
#>
$inspreadsheet = 'C:\Users\Guy\Dropbox\CGC\2024\Financials\Invoicing Income and Expenses\Expenses.xlsx'
$outfile2 = 'C:\Users\Guy\Dropbox\CGC\2024\Financials\Invoicing Income and Expenses\CHQ_Transactions_1.csv'
$custsheet = 'Expenses_2024'                                #Transactions worksheet
#################
$startR = 1                                         #Start row
$endR = 7
...
#################
$csvfile = 'SHEET1.csv'
$pathout = 'C:\Users\Guy\Dropbox\CGC\2024\Financials\Invoicing Income and Expenses\'
$startCol = 1                                                                   #Start Col (don't change)
$endCol = 11                                                                     #End Col (don't change)
$outfile1 = 'C:\Users\Guy\Dropbox\CGC\2024\Financials\Invoicing Income and Expenses\CHQTEMP.txt'              #Temp file
$outfileF = 'C:\Users\Guy\Dropbox\CGC\2024\Financials\Invoicing Income and Expenses\Claim_Transactions_pastel_' + $filter + '.txt'  #File to be imported into Pastel             
...
foreach ($aObj in $data) {
    ...
    #}
    Switch ($aObj.Expacc) {
        AMMO { $ExpenseAcc = '2000004'}        #Expense account for claim        
        Equipment { $ExpenseAcc = '3650000'}        #Expense account for claim        
        Fuel { $ExpenseAcc = '4650000'}        #Expense account for claim        
        GAME { $ExpenseAcc = '2000011'}        #Expense account for claim        
